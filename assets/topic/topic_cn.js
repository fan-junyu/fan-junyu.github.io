document.addEventListener('DOMContentLoaded', () => {
    ...
    const scripts = {
        ...
        brain: { 
            title: "它在我大脑里吗？", 
        text: "大脑是如何将我表征出来的？<br>前额叶，杏仁核。<br>神经递质，通路，网络。<br>中枢与外周神经系统，神经元，胶质细胞。<br>记忆。表象。世界的映像。<br><br>如果大脑是“精神”的器官，<br>那么大脑的边界在哪里？" 
        },
        torso: { 
            title: "它在我的身体里吗？", 
        text: "紧绷的四肢，竖起的寒毛。<br>加速的心跳，急促的呼吸。<br>阳光中的温暖。<br>泥土在脚下的柔软。<br>在拥抱中的放慢、松弛。<br><br>为何我是人类，<br>而不只是另一种动物，<br>或自然万物中的一株植物？" 
     },
        flow: { 
           title: "它从我的环境中生成吗？", 
        text: "顺从，或抗拒<br>受其教化，或对其叛逆<br>依恋，或恐惧<br>受其创伤，或受其诱惑<br><br>我是被激情所驱，还是被成瘾所困<br>——在自我之中，还是在症状之中？" 
 },
        end: { 
            title: "关于“我”的探问", 
        text: "<div class='quote-text'>“精神病理学的界限在于：人之为人，无法被最终分析与穷尽；因为我们越是将人不断还原为典型与规范，就越会意识到，在每一个个体之中，都有某种隐藏之物，拒绝被完全认识。”</div><br>—— 卡尔·雅斯贝尔斯，《普通精神病理学》" 
      }
    };
